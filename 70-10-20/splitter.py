...
def split_dataset(input_directory, output_directory, train_pct=0.7, test_pct=0.1, val_pct=0.2):
...
input_directory = r"./Crop Normal"
output_directory = r"./new/Normal Class1"
